...
def etl_process(**kwargs):
    ...
    with mysql_connection.begin() as connection:
        connection.execute("DELETE FROM Covid.Cases WHERE Type='R'")
...
dag = DAG('InsertDataDagRecover', description='Dag to Ingest covid data',
          default_args={
...
sensor = FileSensor(task_id="file_sensor_task4",
                    dag=dag,
...
etl = PythonOperator(task_id="sales_etl4",
