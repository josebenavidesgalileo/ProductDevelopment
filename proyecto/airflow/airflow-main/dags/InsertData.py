...
def etl_process(**kwargs):
    ...
    with mysql_connection.begin() as connection:
        connection.execute("DELETE FROM Covid.Cases WHERE Type='C'")
...
dag = DAG('InsertDataDag', description='Dag to Ingest covid data',
          default_args={
...
sensor = FileSensor(task_id="file_sensor_task2",
                    dag=dag,
...
etl = PythonOperator(task_id="sales_etl2",
